...
//     console.log("Hi the data at line 16: " + data);
// })

// promise.then(function (data) {
//     console.log("Hi the data at line 20: " +  data);
// })
...
//     console.log("inside first catch", error.message);
// })
...
// promise.then(fcb);
// promise.then(fcb, scb);
// promise.catch(scb);
// promise.then(null, scb);    //catch using then
...
// const promise1 = Promise.reject("Promsie is rejected with value: Some error");
...
// promise
//     .then(function (data) {
//         console.log("then 128: ", data);
//         return "hello";
//     }).catch(function (firstThenVal) {
//         console.log("catch 131: ", firstThenVal);
//         return 100;
//     }).then(function (secondThenVal) {
//         console.log("then 134: ", secondThenVal);
//         return fs.promises.readFile("f1.txt");
//     }).then(function (thirdThen) {
//         console.log("then 137: " + thirdThen);
//     }).catch(function (firstThenVal) {
//         console.log("catch 139: " + firstThenVal);
//         return 100
//     })
 ...
 * and vice versa 
 * 
 * (***Imp)do not leave a rejected promise openly because that completley halt your code 
 * */
