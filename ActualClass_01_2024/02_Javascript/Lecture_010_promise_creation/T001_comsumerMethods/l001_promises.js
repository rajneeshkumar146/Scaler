...
// promise.then(function (data) {
//     console.log("Hi the data 3rd statement: " + data);
// }).then(function (data) {
//     console.log("Hi the data 4th statement: " + data);
// });
...
promise
    .then(function (data) {
        console.log("then 139: ", data);
        return "hello";
    }).catch(function (firstThenVal) {
        console.log("catch 141: ", firstThenVal);
        return 100;
    }).then(function (secondThenVal) {
        console.log("then 145: ", secondThenVal);
        return fs.promises.readFile("f1.txt");
    }).then(function (thirdThen) {
        console.log("then 148: " + thirdThen);
    }).catch(function (firstThenVal) {
        console.log("catch 150: " + firstThenVal);
        return 100
    })
