...
function throttle(fn, haltAllCallForInterval = 500) {
    shouldWait = false;
    return function (...args) {
        // validation check for your call.
        if (shouldWait === true) {
            console.log("this coupon is already applied before wait for 3hr.");
            return;
        }
        ...
        // wait for moment before restting your flag.
        setTimeout(() => {
            shouldWait = false;
